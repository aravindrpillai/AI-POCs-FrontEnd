...
import { ArrowLeft, ArrowRight, Video, FileText, Mic, Brain, Zap, ClipboardList } from "lucide-react";
import { motion } from "framer-motion";
import { Button } from "@/components/ui/button";

const floatingIcons = [
  { Icon: Video, x: "10%", y: "18%", delay: 0, size: 20 },
  { Icon: Brain, x: "87%", y: "20%", delay: 0.5, size: 22 },
  { Icon: Zap, x: "78%", y: "74%", delay: 1, size: 18 },
  { Icon: ClipboardList, x: "14%", y: "70%", delay: 1.4, size: 20 },
];

const steps = [
  { icon: "📁", title: "Upload Content", desc: "Upload a video, audio, or text file with your requirements" },
  { icon: "🤖", title: "AI Extraction", desc: "AI transcribes and extracts detailed content from your file" },
  { icon: "✏️", title: "Edit & Refine", desc: "Review and modify the extracted content in a rich text editor" },
  { icon: "🏷️", title: "Classify", desc: "Tag it as an Epic, User Story, or Task with a proper title" },
  { icon: "🚀", title: "Create Ticket", desc: "Push the refined ticket directly into your project" },
];
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center max-w-2xl w-full">
        ...
        >
          Turn any video recording, audio note, or text file into a well-structured Jira ticket. Our AI extracts and formats the content, letting you refine it before pushing it to your project as an Epic, User Story, or Task.
        </motion.p>
        ...
        >
          <Button
            size="lg"
            onClick={() => navigate("/jira-ai/editor")}
        ...
        >
          ⚠️ AI-generated content is a starting point. Always review and refine before creating the final ticket.
        </motion.p>
      </div>
    </div>
  );
