      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 w-full max-w-6xl">
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.03, y: -4 }}
            whileTap={{ scale: 0.97 }}
            onClick={() => navigate("/finance-advisor")}
            className="group relative flex flex-col items-start gap-4 p-6 rounded-2xl border border-border bg-card text-foreground shadow-card overflow-hidden text-left"
          >
            <div className="absolute -right-6 -bottom-6 w-24 h-24 rounded-full bg-success/[0.08]" />
            <div className="relative">
              <div className="w-11 h-11 rounded-xl bg-success/10 flex items-center justify-center mb-1">
                <Wallet className="w-5 h-5 text-success" />
              </div>
              <h2 className="text-lg font-heading font-bold">Finance AI</h2>
              <p className="text-xs text-muted-foreground mt-1 leading-relaxed">
                AI-powered financial health check & advisor
              </p>
            </div>
            <div className="relative flex items-center gap-1.5 text-xs font-medium text-success mt-auto opacity-70 group-hover:opacity-100 transition-opacity">
              <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-1 transition-transform" />
            </div>
          </motion.button>
          ...
          <motion.button
            ...
            className="group relative flex flex-col items-start gap-4 p-6 rounded-2xl border border-border bg-card text-foreground shadow-card overflow-hidden text-left"
          >
            <div className="absolute -right-6 -bottom-6 w-24 h-24 rounded-full bg-accent/[0.08]" />
            <div className="relative">
              <div className="w-11 h-11 rounded-xl bg-accent/10 flex items-center justify-center mb-1">
                <BookOpen className="w-5 h-5 text-accent" />
              </div>
              <h2 className="text-lg font-heading font-bold">Exam Prep</h2>
              <p className="text-xs text-muted-foreground mt-1 leading-relaxed">
                Upload question banks & quiz yourself with shuffled answers
              </p>
            </div>
            <div className="relative flex items-center gap-1.5 text-xs font-medium text-accent mt-auto opacity-70 group-hover:opacity-100 transition-opacity">
              <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-1 transition-transform" />
          ...
          >
            ...
            <div className="relative">
              ...
              <h2 className="text-lg font-heading font-bold">Ollama Chat</h2>
              <p className="text-xs text-muted-foreground mt-1 leading-relaxed">
                Chat with Ollama AI — text & image conversations
              </p>
            </div>
